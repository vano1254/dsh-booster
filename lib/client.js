...
function PreviewWatcher({ ctx, store, mode, fileOpen, codeServer, sessionId, useChat }) {
...
function FramePane({ target, note, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "booster-preview", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("header", { className: "booster-preview__head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "booster-preview__url", title: target.source, children: target.source }),
...
function WebPanel(props) {
  ...
  const target = sessionId === void 0 ? void 0 : store.get(sessionId);
  if (target === void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "booster-preview__empty", children: t("preview.empty") });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FramePane, { target, note: t("preview.note"), t });
}
function CodeServerRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "booster-codeserver", "data-booster-code-server": state, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "booster-row__hint", children: t(`preview.codeServer.state.${state}`) }),
    state === "none" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "booster-row__hint", children: t("preview.codeServer.hint") }),
      ...
      showCommand && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: "booster-codeserver__command", children: CODE_SERVER_COMMAND })
    ] }),
...
function VSCodePanel(props) {
  ...
  if (preview.codeServer !== "have") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "booster-preview__empty", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CodeServerRow, { preview, set: (value) => store.set("preview", value), t, recheck }) });
  }
      ...
      disposers.push(
        slots.inject(
          ...
          () => slots.register(
            ...
            ((slotProps) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WebPanel, { ...slotProps, store, t }))
          )
        )
      );
      disposers.push(
