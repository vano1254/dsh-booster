...
function PreviewWatcher({ ctx, store, mode, fileOpen, sessionId, useChat }) {
...
var previewModule = {
  ...
  apply({ ctx, settings, t }) {
    ...
    const start = (tabs, mode2, fileOpen2) => {
      ...
      disposers.push(
        slots.inject(
          ...
          () => slots.register(
            ...
            (() => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(VSCodePanel, { t }))
          )
        )
      );
      disposers.push(
        slots.inject(
          ...
          () => slots.register(
            ...
            ((slotProps) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PreviewWatcher, { ...slotProps, ctx, store, mode: mode2, fileOpen: fileOpen2 }))
          )
        )
      );
    };
...
function createModuleManager(ctx, store, modules, t) {
  ...
  const sync = () => {
    ...
    for (const module2 of modules) {
      ...
      if (existing !== void 0) disposeOne(module2.id);
      try {
        const dispose = module2.apply({ ctx, settings, t });
